...
module.exports = {
  MONGO_URL, PORT, JWT_SECRET_DEV, NOT_FOUND_MOVIE_MSG, BAD_DATA_MSG, OTHER_PEOPLES_MOVIES_MSG, REMOVE_MOVIE_MSG,
  MOVIE_NOT_FOUND_MSG, VALID_ERROR, CAST_ERROR, USER_NOT_FOUND_MSG, MONGO_SERVER_ERROR, DUPLICATE_KEY,EMAIL_IS_ALREADY_MSG,
  USER_IS_REGISTERED_MSG, AUTHORIZATION_IS_SUCCESSFUL, TOKEN_REMOVE_MSG, NEED_AUTHORIZED_MSG, ALLOWED_CORS, DEFAULT_ALLOWED_METHODS,
  NAME_REQUEST_LOG, NAME_ERROR_LOG, INCORRECT_EMAIL_PASSWORD, PAGE_NOT_FOUND, INTERNAL_SERVER_ERROR
}
